...
export default function Footer() {
  return (
    <div className='h-12 relative bottom-0 z-10 bg-gradient-to-t from-black to-black/50 w-screen border-t border-t-black text-white flex items-center justify-center'>
        <div>
