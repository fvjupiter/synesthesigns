...
export default function About({ screenHeight }) {
  return (
    <div style={{ minHeight: screenHeight -80 }} className={``}>
      <div style={{ marginTop: screenHeight -200 }} className='backdrop text-white w-11/12 mx-auto sm:w-[620px] md:w-[748px] md:text-2xl sm:text-xl text-base lg:text-3xl px-7 py-5 md:px-8 md:py-6 lg:py-8 lg:px-12 border border-pink-400 rounded-3xl ring-4 bg-black bg-opacity-70 text-justify'>
      ...
      <p>In early 2019 I decided to quit my cultural science &amp; philosophy studies @Universität Bremen to work
          ...
          If you need a 
          secure progressive Web-App / -Site hit me up at <a href= "mailto:schoof.frederik@gmail.com" className='text-blue-300'>schoof.frederik@gmail.com</a>! I&apos;m working with mordern
