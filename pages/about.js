...
export default function About({ screenHeight }) {
  return (
    <div style={{ minHeight: screenHeight -80 }} className={``}>
      <div style={{ marginTop: screenHeight -200 }} className='backdrop text-white w-full mx-auto sm:w-[620px] md:w-[748px] lg:w-[1004px] md:text-2xl sm:text-xl text-base lg:text-3xl px-7 py-5 md:px-8 md:py-6 lg:py-8 lg:px-12 border border-teal-400 rounded-3xl ring-4 sm:ring-black/70 bg-black bg-opacity-70 text-justify'>
